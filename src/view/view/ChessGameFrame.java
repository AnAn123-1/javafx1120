...
public class ChessGameFrame extends JFrame {
    ...
    public ChessGameFrame(int width, int height) {
        ...
        ImageIcon img = new ImageIcon("C:\\Users\\Lenovo\\Desktop\\darkchess\\2c8e731703a167473583f4c04024910a.jpeg");
    ...
    private void addHelloButton() {
        ...
        ImageIcon img = new ImageIcon("C:\\Users\\Lenovo\\Desktop\\darkchess\\QQ图片20221220004144.jpg");
        button.setIcon(img);
        add(button);
    }
    ...
    private void addLoadButton() {
        ...
        ImageIcon img = new ImageIcon("C:\\Users\\Lenovo\\Desktop\\darkchess\\QQ图片20221220004155.jpg");
        button.setIcon(img);
        add(button);
    ...
    private void addSaveButton(){
        ...
        ImageIcon img = new ImageIcon("C:\\Users\\Lenovo\\Desktop\\darkchess\\QQ图片20221220004158.jpg");
        button.setIcon(img);
        add(button);
        button.addActionListener(e -> {
    ...
    private void addCheatButton() {
        ...
        button.setSize(180, 60);
        ImageIcon img = new ImageIcon("C:\\Users\\Lenovo\\Desktop\\darkchess\\QQ图片20221220110507.jpg");
        ImageIcon img2 = new ImageIcon("C:\\Users\\Lenovo\\Desktop\\darkchess\\QQ图片20221220112043.jpg");
        button.setIcon(img);
        add(button);
    ...
    public void addMusicButton() {
        Thread thread1 = new Thread(() -> {
            while (true) {
                Data.playMusic(new File("C:\\Users\\Lenovo\\IdeaProjects\\DC\\src\\Music\\群青.wav"), 0.5);
            }
        });
        Thread thread2 = new Thread(() -> {
            while (true) {
                Data.playMusic(new File("C:\\Users\\Lenovo\\IdeaProjects\\DC\\src\\Music\\恋爱循环.wav"), 0.5);
            }
        });
        Thread thread3 = new Thread(() -> {
            while (true) {
                Data.playMusic(new File("C:\\Users\\Lenovo\\IdeaProjects\\DC\\src\\Music\\夜的钢琴曲五.wav"), 0.5);
            }
        });
        ...
        ImageIcon square = new ImageIcon("C:\\Users\\Lenovo\\IdeaProjects\\DC\\src\\Music\\冷酷的星之卡比.png");//获取一个图片
